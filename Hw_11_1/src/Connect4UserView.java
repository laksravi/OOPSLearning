...
public class Connect4UserView implements Observer {	
	...
	public void update(Observable arg0, Object arg1) {
		if(arg1 instanceof GameControl){
			displayBoard(((GameControl)arg1).getGameBoard().getBoardMatrix(), Connect4GameModel.getMaxRows(), Connect4GameModel.getMaxColumns());
		}
		else if ( arg1 instanceof PlayerModel){
			System.out.println("Turn of the Player  "+((PlayerModel)arg1).getName());
