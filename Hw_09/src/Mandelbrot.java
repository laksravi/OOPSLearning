 ...
 *
 */
class PixThread extends Thread {
	...
	public PixThread(int x, int y, Mandelbrot m){
		xIndex = new Stack<Integer>();
		yIndex = new Stack<Integer>();
		inputOver = false;
...
public class Mandelbrot extends JFrame {
	...
	public void createSet() {
		...
		PixThread pixelThreads[] = new PixThread[processorCount];
		PixThread.setCommonProperties(LENGTH, ZOOM, MAX);
		for(int index=0; index < processorCount; index++){
			pixelThreads[index] = new PixThread(0,0,this);
